...
const API_BASE_URL = "https://aigsolution.com.ng/app/api/fund-wallet/index.php";
...
export default function FundAccountPage() {
  ...
  const handleRefresh = useCallback(async () => {
    try {
      ...
      const response = await fetch(
        "https://aigsolution.com.ng/app/api/user/app-refresh/index.php",
        {
          method: "POST",
  ...
  const handleGenerateAccount = async () => {
    ...
    try {
      const response = await fetch(
        `https://aigsolution.com.ng/app/debug.php?token=${encodeURIComponent(
          token
        )}`,
        {
          method: "POST",
  ...
  const submitManualVerification = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://aigsolution.com.ng/app/api/fund-wallet/manual/index.php",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            ...
            >
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="text-right">
                  ...
                  <h4 className="font-bold">Ali Ibrahim</h4>
                </div>
              </div>
              <div
