...
export default function FintechDashboard() {
  ...
  const handleTransferCashback = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://aigsolution.com.ng/app/api/user/cashback-transfer/index.php",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ phone }),
      ...
      >
          ...
          onClick={async () => {
            ...
            window.open(
              `https://wa.me/${adminPhone}?text=${encodeURIComponent(
                "Hello, I am using the Aigsolution App. I would like to suggest a new service: "
              )}`,
              "_blank"
            );
          }}
        ...
        <div
          ...
          onClick={async () => {
            ...
            window.open(
              `https://wa.me/${adminPhone}?text=${encodeURIComponent(
                `Hello Admin, I am ${userName}. I need assistance with the Aigsolution App.`
              )}`,
              "_blank"
            );
          }}
